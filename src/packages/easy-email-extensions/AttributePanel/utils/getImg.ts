...
const defaultImagesMap = {
  ...
  AttributePanel_01:
    'https://edit.url2.shop' + '/images/e22f78f2-aa76-408d-ba94-c95c7abe1908-image.png',
  AttributePanel_02:
    'https://edit.url2.shop' + '/images/3e952a6e-2506-470e-b395-3e0d995157c5.png',
  AttributePanel_03:
    'https://edit.url2.shop' + '/images/Fi_vI4vyLhTM-Tp6ivq4dR_ieGHk.png',
};
